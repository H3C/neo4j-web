...
export class Visualization extends Component {
  ...
  populateDataToStateFromProps(props) {
    // console.log('[add] populateDataToStateFromProps: ', props.result.records)
    const {
      nodes,
      relationships
        ...
        this.props.bus.self(
          ...
          response => {
            if (!response.success) {
              ...
              // console.log('[add] getNeighbours: ', response.result.records)
        ...
        this.props.bus.self(
          ...
          response => {
            if (!response.success) {
              ...
              // console.log('[add] getInternalRelationships: ', response.result.records)
              resolve({
                ...bolt.extractNodesAndRelationshipsFromRecordsForOldVis(
                  response.result.records,
                  false
